...
class QNet:
    ...
    def experience_replay(self, time):
        if self.initial_exploration < time:
            ...
            loss, _ = self.forward(s_replay, a_replay, r_replay, s_dash_replay, episode_end_replay)# def forward(self, state, action, reward, state_dash, episode_end):
            loss.backward()
    ...
    def index_to_action(self, index_of_action):
        return self.enable_controller[index_of_action]       #[index_of_action]=np.argmax(q)
